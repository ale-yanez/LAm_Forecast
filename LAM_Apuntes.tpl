...
// se considera el Fpbr de hembras como el representativo factor limitante
 ...
 { // son # PBR only!
	...
	for (int i=1;i<=nyear_proy;i++)
	{
		...
		NMDp=elem_prod(Nph,mfexp(-dt(1)*(Zpbrh)))*Prob_talla_h; //llevo a inicio 2019 Falta Rec. Es la abundancia que vino del 2018 y ahora esta en el inicio de 2019 y le falta el Rec
