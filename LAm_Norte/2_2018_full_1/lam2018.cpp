...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
 ...
 log_s1priorcm = log(sel_ini(4,2));
  ...
  recOp.allocate("recOp");
  ajRh.allocate("ajRh");
  ajRm.allocate("ajRm");
  nFt.allocate("nFt");
  mf.allocate(1,nFt,"mf");
  Fmsy.allocate("Fmsy");
  rCaph.allocate("rCaph");
  rCapm.allocate("rCapm");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  Yh.allocate(1,nyears,"Yh");
  Ym.allocate(1,nyears,"Ym");
  ...
  Rfemale.allocate(1,nyears,"Rfemale");
  Rmale.allocate(1,nyears,"Rmale");
  Rec.allocate(1,nyears,"Rec");
  ...
  Fmale.allocate(1,nyears,"Fmale");
  Ffemale.allocate(1,nyears,"Ffemale");
  Ftotal.allocate(1,nyears,"Ftotal");
  Nhp.allocate(nyears,nyears+nyear_proy,1,nedades,"Nhp");
  #ifndef NO_AD_INITIALIZE
    Nhp.initialize();
  #endif
  Nmp.allocate(nyears,nyears+nyear_proy,1,nedades,"Nmp");
  #ifndef NO_AD_INITIALIZE
    Nmp.initialize();
  #endif
  Shp.allocate(nyears,nyears+nyear_proy,1,nedades,"Shp");
  #ifndef NO_AD_INITIALIZE
    Shp.initialize();
  #endif
  Smp.allocate(nyears,nyears+nyear_proy,1,nedades,"Smp");
  #ifndef NO_AD_INITIALIZE
    Smp.initialize();
  #endif
  Fhp.allocate(nyears,nyears+nyear_proy,1,nedades,"Fhp");
  #ifndef NO_AD_INITIALIZE
    Fhp.initialize();
  #endif
  Fmp.allocate(nyears,nyears+nyear_proy,1,nedades,"Fmp");
  #ifndef NO_AD_INITIALIZE
    Fmp.initialize();
  #endif
  Zhp.allocate(nyears,nyears+nyear_proy,1,nedades,"Zhp");
  #ifndef NO_AD_INITIALIZE
    Zhp.initialize();
  #endif
  Zmp.allocate(nyears,nyears+nyear_proy,1,nedades,"Zmp");
  #ifndef NO_AD_INITIALIZE
    Zmp.initialize();
  #endif
  cehp.allocate(nyears,nyears+nyear_proy,1,nedades,"cehp");
  #ifndef NO_AD_INITIALIZE
    cehp.initialize();
  #endif
  cemp.allocate(nyears,nyears+nyear_proy,1,nedades,"cemp");
  #ifndef NO_AD_INITIALIZE
    cemp.initialize();
  #endif
  Rhp.allocate(nyears,nyears+nyear_proy,"Rhp");
  #ifndef NO_AD_INITIALIZE
    Rhp.initialize();
  #endif
  Rmp.allocate(nyears,nyears+nyear_proy,"Rmp");
  #ifndef NO_AD_INITIALIZE
    Rmp.initialize();
  #endif
  Rtot.allocate(nyears,nyears+nyear_proy,"Rtot");
  #ifndef NO_AD_INITIALIZE
    Rtot.initialize();
  #endif
  Fthp.allocate(nyears,nyears+nyear_proy,"Fthp");
  #ifndef NO_AD_INITIALIZE
    Fthp.initialize();
  #endif
  Ftmp.allocate(nyears,nyears+nyear_proy,"Ftmp");
  #ifndef NO_AD_INITIALIZE
    Ftmp.initialize();
  #endif
  Ftp.allocate(nyears,nyears+nyear_proy,"Ftp");
  #ifndef NO_AD_INITIALIZE
    Ftp.initialize();
  #endif
  SBp.allocate(nyears,nyears+nyear_proy,"SBp");
  #ifndef NO_AD_INITIALIZE
    SBp.initialize();
  #endif
  BTt.allocate(nyears,nyears+nyear_proy,"BTt");
  #ifndef NO_AD_INITIALIZE
    BTt.initialize();
  #endif
  Yhp.allocate(nyears,nyears+nyear_proy,"Yhp");
  #ifndef NO_AD_INITIALIZE
    Yhp.initialize();
  #endif
  Ymp.allocate(nyears,nyears+nyear_proy,"Ymp");
  #ifndef NO_AD_INITIALIZE
    Ymp.initialize();
  #endif
  whp.allocate(1,ntallas,"whp");
  #ifndef NO_AD_INITIALIZE
    whp.initialize();
  #endif
  wmp.allocate(1,ntallas,"wmp");
  #ifndef NO_AD_INITIALIZE
    wmp.initialize();
  #endif
  Sel_flohp.allocate(1,nedades,"Sel_flohp");
  #ifndef NO_AD_INITIALIZE
    Sel_flohp.initialize();
  #endif
  Sel_flomp.allocate(1,nedades,"Sel_flomp");
  #ifndef NO_AD_INITIALIZE
    Sel_flomp.initialize();
  #endif
  Yproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Yproy");
  Yhproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Yhproy");
  Ymproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Ymproy");
  Fproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Fproy");
  Fhproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Fhproy");
  Fmproy.allocate(nyears,nyears+nyear_proy,1,nFt,"Fmproy");
  SSBpj.allocate(nyears,nyears+nyear_proy,1,nFt,"SSBpj");
  BTpj.allocate(nyears,nyears+nyear_proy,1,nFt,"BTpj");
  Rtotpj.allocate(nyears,nyears+nyear_proy,1,nFt,"Rtotpj");
  Rhpj.allocate(nyears,nyears+nyear_proy,1,nFt,"Rhpj");
  Rmpj.allocate(nyears,nyears+nyear_proy,1,nFt,"Rmpj");
}
