...
dir.1<-'~/Documents/ADMwork/IFOP/2020/Analisis_Proyecciones/' # Folder donde se almacenan las 3 carpetas y el .R
dir.2<-'~/Documents/ADMwork/IFOP/2020/Analisis_Proyecciones/1_2019_full/'
dir.3<-'~/Documents/ADMwork/IFOP/2020/Analisis_Proyecciones/2_2019_Oct/'
dir.4<-'~/Documents/ADMwork/IFOP/2020/Analisis_Proyecciones/3_2018_full/'
...
p8 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  scale_color_manual(name = '',
                     values = c('royalblue3', 'red1', 'gold1'),
                     limits = c('2019_full', '2019_oct', '2018_full'),
                     breaks = c('2019_full', '2019_oct', '2018_full')) +
...
p9 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  #geom_ribbon(data=NULL, aes(ymin=c(desvrec2_lwr), ymax=c(desvrec2_upr)),fill = 'grey70', alpha = 0.4) + 
  #geom_ribbon(data=NULL, aes(ymin=c(rec3_lwr, NA), ymax=c(rec3_upr, NA)), fill = 'grey90', alpha = 0.4) + 
  geom_line(aes(y = c(rep(0,35)), colour = '', linetype = '')) +
  scale_color_manual(name = '',
                     values = c('royalblue3', 'red1', 'gold1', 'black'),
                     limits = c('2019_full', '2019_oct', '2018_full', ''),
                     breaks = c('2019_full', '2019_oct', '2018_full', '')) +
...
p10 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  scale_color_manual(name = '',
                     values = c('royalblue3', 'red1', 'gold1', 'green'),
                     limits = c('2019_full', '2019_oct', '2018_full','Brms'),
                     breaks = c('2019_full', '2019_oct', '2018_full','Brms')) +
  
  
  scale_linetype_manual(name = '',
                        values = c('solid', 'dashed', 'longdash','longdash'),
                        limits = c('2019_full', '2019_oct', '2018_full','Brms'),
                        breaks = c('2019_full', '2019_oct', '2018_full','Brms'))
...
p11 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  scale_color_manual(name = '',
                     values = c('royalblue3', 'red1', 'gold1', 'chartreuse3'),
                     limits = c('2019_full', '2019_oct', '2018_full', 'Brms'),
                     breaks = c('2019_full', '2019_oct', '2018_full', 'Brms')) +
...
p12 <- ggplot(data = NULL, aes(x = yrs)) + 
  ...
  scale_color_manual(name = '',
                     values = c('royalblue3', 'red1', 'gold1', 'chartreuse3','black'),
                     limits = c('2019_full', '2019_oct', '2018_full', 'M', 'Frms'),
                     breaks = c('2019_full', '2019_oct', '2018_full', 'M', 'Frms')) +
  
  
  scale_linetype_manual(name = '',
                        values = c('solid', 'dashed', 'longdash', 'twodash','dotted'),
                        limits = c('2019_full', '2019_oct', '2018_full', 'M', 'Frms'),
                        breaks = c('2019_full', '2019_oct', '2018_full', 'M', 'Frms'))
